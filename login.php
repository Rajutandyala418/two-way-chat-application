...
<div class="container">
    <button type="button" onclick="window.location.href='index.php'" class="back-btn inside">
...
<input type="text" name="login_input" placeholder="Enter username or email" autocomplete="new-username" required>
</div>
